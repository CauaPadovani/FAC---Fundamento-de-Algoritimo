/*
	...
	QUESTÃO 11:
	Fazer um função que, dados dois vetores A e B com números 
	inteiros, gerar o vetor C que consiste na intersecção dos dois 
	primeiros.
...
void main ()
{
	...
	//chamando a função
	intersecao (A, TAMA, B, TAMB, C, &quantidadeC);
...
void intersecao (int vetA[], int quantA, int vetB[], int quantB, int vetC[], int *quantC)
{
	...
	*quantC = 0;
	...
	//copiando para C os elementos de B que também estão em A
	for (i=0;i<quantB;i++)
	{
